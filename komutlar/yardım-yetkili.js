...
exports.run = (client, message, args) => {
  ...
  .setAuthor('Wonders - Yetkili Komutları', client.user.avatarURL)
  .setThumbnail(client.user.avatarURL)
  .setColor('BLACK')
  .setDescription(`**• w!ban @kullanıcı** ➜ Bir kişiyi sunucudan banlarsınız. \n**• w!kick @kullanıcı** ➜ Bir kişiyi sunucudan atarsınız. \n**• w!temizle <0-100>** ➜ Bir kanalda mesajları silersiniz. \n**• w!unban @kullanıcı** ➜ Bir kişinin banını kaldırırsınız. \n**• w!rol-oluştur <rol-adı>** ➜ Bir rol oluşturursunuz. \n\n   [Bot Davet Linki](https://discord.com/oauth2/authorize?client_id=734341007012921364&scope=bot&permissions=8)   |   [Destek Sunucusu](https://discord.gg/XkarS52)`)
  .setTimestamp()
